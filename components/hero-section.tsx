                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <Blob 
                                    ...
                                    duration={25}
                                    xPath={["-10vw", "50vw", "-20vw", "-10vw"]}
                                    yPath={["-10vh", "-40vh", "-60vh", "-10vh"]}
                                    className="w-[600px] h-[600px] opacity-100 -z-10"
                                />
                                <Blob 
                                    src="/images/yellow-blob.png" 
                                    duration={40}
                                    xPath={["-50vw", "90vw", "20vw", "-50vw"]}
                                    yPath={["-10vh", "10vh", "80vh", "-10vh"]}
                                    className="w-[300px] h-[300px] opacity-100 -z-10"
                                />
                                <Blob 
                                    src="/images/pink-blob.png" 
                                    duration={20}
                                    xPath={["70vw", "10vw", "50vw", "70vw"]}
                                    yPath={["90vh", "20vh", "60vh", "90vh"]}
                                    className="w-[200px] h-[200px] opacity-100 -z-10"
                                />
                                <Blob 
                                    src="/images/pink-blob.png" 
                                    duration={20}
                                    xPath={["10vw", "40vw", "40vw", "10vw"]}
                                    yPath={["-40vh", "20vh", "70vh", "-40vh"]}
                                    className="w-[500px] h-[500px] opacity-100 -z-10"
                                />
                                <TextEffect
                                    preset="fade-in-blur"
                                    speedSegment={0.3}
                                    ...
                                    <SignedOut>
                                        <SignUpButton mode="modal">
                                            <Button
                                                asChild
                                                size="lg"
                                                className="relative z-10 cursor-pointer rounded-xl px-5 text-base">
                                                    <span className="text-nowrap cursor-pointer">Join Us</span>
                                            </Button>
                                        </SignUpButton>
                                    </SignedOut>
                                    </div>
